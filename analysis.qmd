...
second wave (approx. 20 months after baseline). Each school, class and pupil
...
in comparison to control schools. Reported victimisation increases for both groups
between the baseline and the first wave, most likely due to the timing of the measurement 
(beginning vs. end of the school year).
...
(vic_bin_marg_eff_plot <- vic_plot_by_group + vic_plot_diff +
  plot_annotation(
    title = paste0("**After nearly 2 years of implementation, 
